...
function (_React$PureComponent) {
  ...
  (0, _createClass2["default"])(BaseTable, [{
    ...
    value: function renderFooter(_ref6) {
      ...
      var extraProps = (0, _utils.callOrReturn)(this.propsfooterrProps, {
        columns: columns,
        footerIndex: footerIndex
      });
    ...
    value: function _handleRowExpand(_ref13) {
    ...
    value: function _handleColumnResize(_ref14, width) {
      var key = _ref14.key;
    ...
    value: function _handleColumnResizeStart(_ref15) {
      var key = _ref15.key;
      this.setState({
        resizingKey: key
      });
